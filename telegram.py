...
class TelegramOutput(TeleBot, OutputChannel):
    ...
    async def send_text_message(
        ...
        reply_id = kwargs.get('response_id')
        reply_markup = kwargs.get('reply_markup')
        for message_part in text.strip().split("\n\n"):
            self.send_message(recipient_id, message_part,reply_to_message_id=reply_id)
    ...
    async def send_text_with_buttons(
        ...
        **kwargs: Any,
        ...
        reply_id = kwargs.get('response_id')
        self.send_message(recipient_id, text, reply_markup=reply_markup,reply_to_message_id=reply_id)
